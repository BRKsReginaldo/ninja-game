...
let gameOptions = {
	...
	showGUI: true,
	bonusTime: 3,
	localStorageName: '@irresponsible/score',
	initialTime: 30,
	soundOn: true
};
...
class playGame extends Phaser.Scene {
	...
	create() {
		this.bestScore = localStorage.getItem(gameOptions.localStorageName) || 0;
		this.mountains = 0;
	...
	showGameScore() {
		...
		this.scoreText = this.add.bitmapText(energyBounds.right, energyBounds.top - 40, 'font', `DISTANCIA: ${this.mountains.toString()}`);
		this.scoreText.setOrigin(1, 0);

		this.bestScoreText = this.add.bitmapText(energyBounds.left, energyBounds.bottom + 10, 'font', `DISTANCIA MAXIMA: ${this.bestScore.toString()}`);
	...
	updateScore() {
		this.scoreText.setText(`DISTANCIA: ${this.mountains}`);
